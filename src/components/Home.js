    ...
    return (
        <>
            ...
            <section>
                ...
                <div className="video">
                    <main class="scrollss s-two" data-section-name="s-two">
                        <div class=" ">
                            <div class="">
                                <div class="col-lg-12">
                                    <div className="video-part">
                                        ...
                                        {/* <form action="">
                                            <textarea name="" placeholder='Add comment..' id="" rows="2"></textarea><button>Add</button>
                                        </form> */}
                                    </div>
                                </div>
                            </div>
                    ...
                    <main class="scrollss s-three" data-section-name="s-three">
                        <div class=" s">
                            <div class="">
